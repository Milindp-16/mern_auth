  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-300'>
       ...
       <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
          ...
          <h2 className='text-3xl font-semibold text-white text-center mb-3'>{state === 'Sign Up' ? 'Crreate Account':'Login'}</h2>

          <p className='text-center text-sm mb-6'>{state === 'Sign Up' ? 'Crreate your Account':'Login to your Account'}</p>
          ...
          <form onSubmit={onSubmitHandler}>
            ...
            <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-600 to-indigo-900 text-white font-medium'>{state}</button>
          </form>
