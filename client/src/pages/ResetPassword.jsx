  ...
  return (
    ...
    {!isEmailSent && 
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm '>
        ...
        <div className='flex items-center mb-4 gap-3 w-full px-5 py-2.5'>
          <img src={assets.mail_icon} alt="" className='w-3 h-3'/>
          <input type="email" placeholder='Email ID' className='bg-transparent outline-none text-white'
          value={email} onChange={e => setEmail(e.target.value)} required/>
        </div>
        <button className='w-full py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-900 text-white rounded-full mt-3'>Submit</button>
      </form>
    ...
    {!isOtpSubmited && isEmailSent &&
        <form onSubmit={onSubmitOTP} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm '>
            ...
            <button className='w-full py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-900 text-white rounded-full'>Submit</button>
        </form>
    }
